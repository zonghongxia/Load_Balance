...
//static process m_sub_process[process_number] = {0};
...
public:
	static processpool<T>* create(int listenfd,int process_number = 8)
	{
		...
		{	
			...
			cout<<"m_instance,dizhi:"<<m_instance<<endl;
		}
		return m_instance;
	}
	...
	{
		cout<<"xigou"<<endl;
		if(m_sub_process != NULL)
		{
			cout<<"*********************~m_sub_process,dizhi:*******************"<<m_sub_process<<endl;
	...
	:m_listenfd(listenfd),m_process_number(process_number),m_idx(-1)
{
	...
	//process _process[process_number] = {0};
	//m_sub_process = _process;
